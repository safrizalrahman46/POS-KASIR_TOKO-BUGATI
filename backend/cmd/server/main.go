...
func main() {
	...
	orderService := services.NewOrderService(orderRepo, productRepo, voucherRepo, autoDiscountRepo, notifRepo, hub)
	...
	routes.Setup(r, jwtSvc, hub,
		authHandler, categoryHandler, productHandler, orderHandler,
