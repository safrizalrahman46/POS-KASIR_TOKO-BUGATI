...
function ScannerModal({ onScan, onClose }: { onScan: (code: string) => void; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white dark:bg-gray-800 rounded-3xl p-5 w-full max-w-sm mx-auto shadow-2xl" onClick={e => e.stopPropagation()}>
          ...
          cart.items.map((item: any) => (
            <div key={item.product_id} className="group flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-gray-700/40 hover:bg-gray-100 dark:hover:bg-gray-700/60 transition-all">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-semibold text-gray-800 dark:text-white truncate">{item.product_name}</div>
...
function PaymentModal({ total, onSubmit, onClose, loading }: {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 w-full max-w-md mx-auto shadow-2xl" onClick={e => e.stopPropagation()} style={{ animation: 'scaleIn 0.2s ease-out' }}>
...
function ReceiptModal({ order, onClose }: { order: any; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 w-full max-w-sm mx-auto shadow-2xl" onClick={e => e.stopPropagation()}>
        <div ref={printRef}>
          <div className="text-center mb-4">
