        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="table-body">
              {loading ? (
                <tr>
                  <td colSpan={8} className="px-4 py-12 text-center text-[#7A6548]">Memuat...</td>
                </tr>
              ) : products.length === 0 ? (
                <tr>
                  <td colSpan={8} className="px-4 py-12 text-center text-[#7A6548]">Tidak ada produk</td>
                </tr>
              ) : (
                products.map((p) => {
                  ...
                  return (
                    <tr key={p.id}>
                      <td>
                        {p.image ? (
                          <img src={p.image} alt={p.name} className="w-9 h-9 rounded-lg object-cover bg-[#FFF8C8]" />
                        ) : (
            ...
            <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-24 h-24 bg-[#FFFDF2] rounded-xl border-2 border-dashed border-[#F2D98D] flex items-center justify-center overflow-hidden">
                {imagePreview ? (
                  ...
                  <img src={form.image} alt="Produk" className="w-full h-full object-cover" />
                ) : (
